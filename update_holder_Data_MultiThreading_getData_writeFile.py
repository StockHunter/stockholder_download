...
STOCK_HOLDER_INFO = 2
STOCK_AVG_NUM = 3
FILEPATH_BASE = "D:\\python_SRC\\Stock_SRC\\Ver1.0\\dataUpDateLog\\"
FILEPATH_BASE2 = "D:\\python_SRC\\Stock_SRC\\Ver2.0\\AllHtmlData\\20170905\\"
...
def updateStockHolderCnt(tid):
    ...
    while True:
        ...
        FILEPATH_BASE2 = FILEPATH_BASE2+str(stockcode)+".txt"
        ...
        if stockcode > 600738:
            ...
            time1 = time.time()
            stockholder_info_url = stockholder_info_web
...
def updateEnd():
    ...
    print("Log path: %s" % (FILEPATH_BASE2))
    print("Update OK.")
